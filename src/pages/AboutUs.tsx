  ...
  return (
    <>
      ...
      <main className='relative'>
        <section className=' rounded-br-bg-corner bg-prime-blue-rich w-full ov-md:pb-20 ov-md:pt-20 sm:pb-20 flex flex-col items-center'>
        ...
        <section className='relative rounded-tl-bg-corner bg-prime-blue-muted w-full pt-20 pb-20 flex flex-col items-center'>
          <RichBlueTLSquare />
          <div className='sm:w-11/12 ov-md:w-7/10'>
