  ...
  return (
    <>
      ...
      <main className='relative'>
        <section className='bg-prime-blue-rich w-full ov-md:pb-20 ov-md:pt-20 sm:pb-20 flex flex-col items-center
        ...
        '>
          <div className='sm:w-11/12 md:w-[716px] lg:w-[895px] xl:w-[1075px] 2xl:w-[1364px]'>
            <h1 className='text-white sm:text-2xl ov-md:text-4xl font-semibold pt-10 mb-5'>ABOUT US</h1>
            <div className='shadow-xl mb-10 text-xs p-3.5'> キャッチコピーを手書き文字のような感じにしたいです。（エモい感じの） トップページと同じでいいです </div >
            <p className='text-white sm:text-2xl ov-md:text-4xl font-semibold' >OUR MISSION</p>
        ...
        <section className='relative bg-prime-blue-muted w-full pt-20 pb-20 flex flex-col items-center
        sm:rounded-tl-bg-corner md:rounded-tl-bg-corner lg:rounded-tl-bg-corner xl:rounded-tl-bg-corner 2xl:rounded-tl-bg-corner-2xl'>
          <RichBlueTLSquare />
          <div className='sm:w-11/12 md:w-[716px] lg:w-[895px] xl:w-[1075px] 2xl:w-[1364px]'>
            <div className='text-prime-blue-rich sm:text-2xl ov-md:text-4xl font-semibold mb-5'>運営について</div >
        ...
        <section className='bg-prime-blue-muted flex flex-col items-center'>
          <div className=' sm:w-11/12 md:w-[716px] lg:w-[895px] xl:w-[1075px] 2xl:w-[1364px]'>
            <div className='text-prime-blue-rich sm:text-2xl ov-md:text-4xl font-semibold mb-5'>ABOUT LOGO</div >
            <div className='w-full ov-md:grid ov-md:grid-cols-2 ov-md:grid-flow-row'>
              ...
              <div className='sm:w-full sm:flex sm:justify-center sm:pb-20'>
                <div className='relative sm:w-1/3 sm:h-72 ov-md:w-full ov-md:h-56'>
                  <Image layout='fill' objectFit='contain' src='/images/logo-origin.png' />
                </div>
              </div >
            </div>
          </div>
