...
const FavoriteEvent = () => {
  return (
    <>
      <Header />
      <div>
        <h1 className='inline-block'>お気に入り診療科</h1><p className='inline'>マイページ > お気に入り診療科</p>
      </div>
      <div className='w-full mt-[100px] '>


      <TabMenu >
        <div title='診療科の追加と削除' className='h-[400px] bg-red-600 w-full flex flex-col items-stert'>
          <div>
          <div>あｓｄｆ；ヵｓｊ</div>
          <div>あｓｄｆ；ヵｓｊ</div>
          <div>あｓｄｆ；ヵｓｊ</div>
