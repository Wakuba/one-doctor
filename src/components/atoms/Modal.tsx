...
export const ModalMainArea = (props: { closeModal: MouseEventHandler<HTMLDivElement>; children: ReactNode; modalWrapperStyle: string; modalContainerStyle: string }) => {
  return (
    <div onClick={props.closeModal} className={` bg-gray-100 rounded-xl backdrop-filter backdrop-blur bg-opacity-70 fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 overflow-y-scroll ${props.modalWrapperStyle}`}>
