...
const CancelButton = ({ onCancel }: { onCancel: MouseEventHandler<HTMLDivElement> }) => (
  <div onClick={onCancel} className='absolute top-2 right-2 ov-md:h-10 ov-md:w-10 sm:h-6 sm:w-6 bg-gray-300 rounded-full flex flex-col items-center justify-center'>
...
export const ModalMainArea = ({ closeModal, children, modalWrapperStyle, modalContainerStyle }: ModalMainAreaPropsType) => {
  ...
  return (
    ...
    >
      <div className={`${modalContainerStyle} relative space-y-4 ov-md:p-8 sm:p-6`}>
