...
const CancelButton = ({ onCancel }: { onCancel: MouseEventHandler<HTMLDivElement> }) => (
  <div onClick={onCancel} className='fixed top-4 right-4 ov-md:h-10 ov-md:w-10 sm:h-6 sm:w-6 bg-gray-300 rounded-full flex flex-col items-center justify-center'>
...
export const ModalBackdrop = ({ closeModal }: { closeModal: MouseEventHandler<HTMLDivElement> }) => (
  <div className='w-full h-full fixed top-0 left-0 bg-white bg-opacity-10 backdrop-filter backdrop-blur z-20' onClick={closeModal} >
