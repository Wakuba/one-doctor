...
export default function CrewCard({ crewData }: CrewCardPropsType) {
  ...
  return (
    ...
    >
      <div
        className={`w-full h-full preserve-3d duration-700 cursor-pointer relative ${
  ...
  return (
    ...
    >
      <div className="relative grid grid-cols-10 w-full h-full shadow-lg backface-invisible wk-backface-invisible  crew-bg-blue border-1 border-prime-blue-rich rounded-sm">
        ...
        <div className="col-span-6 sm:px-2 ov-md:px-4 sm:text-xs md:text-xs lg:text-xs xl:text-xs 2xl:text-sm flex flex-col justify-evenly">
          <div>
            <p>{position}(役職)</p>
