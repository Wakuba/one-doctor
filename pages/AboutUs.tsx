    ...
    return(
        <>
            ...
            <main className='relative'> 
                <div className=' rounded-br-bg-corner bg-prime-blue-rich w-full sm:px-1/20 ov-md:px-1/6 ov-md:py-20 sm:pb-20'>
                ...
                <div className='relative rounded-tl-bg-corner bg-prime-blue-muted w-full sm:px-1/20 ov-md:px-1/6 pt-20 pb-20'>
                    <RichBlueTLSquare/>
                ...
                <div className='bg-prime-blue-muted sm:px-1/20 ov-md:px-1/6'>
